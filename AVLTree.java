...
class AVLTree{
    ...
    private TreeNode insertHelper(int data, TreeNode node){
        if (node == null){
        size++;
    ...
    private TreeNode removeHelper(int data, TreeNode node){
        if(node == null){
        ...
        if (node.left == null){
            ...
            TreeNode temp = successor(node.right);
            node.data = temp.data;
    ...
    private boolean searchHelper(int data, TreeNode node){
        if(node == null){
        return false;
        }
        if(node.data == data){
